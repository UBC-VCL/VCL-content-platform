          ...
          return (
                <React.Fragment key={ref}>
                  ...
                  >
                      ...
                      <Link
                          href={`${ROUTES.PROJECT.BASE}/${`${ROUTES.PROJECT.BASE}`}`}
                          ...
                          CONSTANTS.PROJECTS.map((project, i) => { 
                              return (
                                  ...
                                  onClick={handleProjectMenuClose}>
                                      <Link
                                          href={`${ROUTES.PROJECT.BASE}/${project.name}`}
                                          className={`nav-link project-name ${router.pathname.split('/')[2] === project.name ? 'active' : ''}`}
                                      >
                                          {project.name}
                                      </Link>
                                  </MenuItem>
