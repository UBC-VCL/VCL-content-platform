...
const ExpandedTimelineContent: React.FC<TimelineCommitBlockProps> = (props) => {
    const { author, title, project, date, categories, descriptions, hyperlinks, contributors, updatedTime, isLoggedIn} = props;
...
const ClosedTimelineContent: React.FC<TimelineCommitBlockProps> = (props) => {
    const { author, title, project, date, categories, isLoggedIn } = props;
    let colorOfProject = '#848484';
