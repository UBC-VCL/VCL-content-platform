    ...
    <div className="join-our-team-homepage">
      <div className="project-breadcrumbs">
        <ProjectBreadcrumbs
          ...
          page_name={TEXT.PROJECT_NAV.JOIN_OUR_TEAM}
        />
      </div>
      <section className="full-bleed">
        <div className="intro-to-join-our-team">
          <div className="left-side">
            ...
            <p className="co-pilot-description">
        ...
        <div className="you-might-like">
          ...
          <div className="row">
            <div className="column">
              <img
                src={js}
                style={{ width: "65%", marginTop: "-11%", marginLeft: "100%" }}
              />
            </div>
            <div className="column">
              <img
                src={appResearch}
                style={{ width: "90%", marginTop: "-6%", marginLeft: "65%" }}
              />
            </div>
            <div className="column">
              <img
                src={dataViz}
                style={{ width: "90%", marginTop: "-2%", marginLeft: "50%" }}
              />
            </div>
            <div className="column">
              <img
                src={visualAttention}
                style={{ width: "115%", marginTop: "-5%", marginLeft: "25%" }}
              />
            </div>
            <div className="column">
              <img
                src={compModel}
                style={{ width: "115%", marginTop: "-11%", marginLeft: "27%" }}
              />
            </div>
          </div>
        </div>
      ...
      <section id="application-instructions-div" className="full-bleed6">
        <div className="Application-Instructions">
          <p
            style={{ paddingTop: "7%", textAlign: "center", color: "#B2C9EC" }}
          >
            05
          </p>
          <h2
          ...
          >
            {TEXT.PROJECT_JOIN.APPLICATION_INSTRUCTIONS.TITLE}
          </h2>
          <div className="app-row">
            <div className="rectangle-card">
              ...
              <p style={{ fontWeight: "800" }}>
                {TEXT.PROJECT_JOIN.APPLICATION_INSTRUCTIONS.STEP1.TITLE}
              </p>
              <p style={{ marginBottom: "6%", paddingRight: "70px" }}>
                {TEXT.PROJECT_JOIN.APPLICATION_INSTRUCTIONS.STEP1.TEXT}
              </p>
              <div
                onClick={() => {
                  // used to redirect the user and also send information with that redirect to the desired URL
                  history.push(ROUTES.HOME, {
                    sourcePage: "project-join-home-redirect-from-goButton",
                  });
                }}
                style={{
                  marginLeft: "10%",
                  backgroundColor: "#1C426D",
                  marginRight: "60%",
                  cursor: "pointer",
                }}
              >
            ...
            <div className="rectangle-card">
              ...
              <VerticalSpacer height={90} />
              <p style={{ fontWeight: "800" }}>
                {TEXT.PROJECT_JOIN.APPLICATION_INSTRUCTIONS.STEP2.TITLE}
              </p>
              <p style={{ marginBottom: "2%", paddingRight: "70px" }}>
                {TEXT.PROJECT_JOIN.APPLICATION_INSTRUCTIONS.STEP2.TEXT}
              </p>
              <ul
                style={{
                  marginLeft: "70px",
              ...
              >
                <li>
                  {
                    TEXT.PROJECT_JOIN.APPLICATION_INSTRUCTIONS.STEP2
                      .BULLET_POINTS.BULLET_1
                  }
                </li>
                <li>
                  {
                    TEXT.PROJECT_JOIN.APPLICATION_INSTRUCTIONS.STEP2
                      .BULLET_POINTS.BULLET_2
                  }
                </li>
                <li>
                  {
                    TEXT.PROJECT_JOIN.APPLICATION_INSTRUCTIONS.STEP2
                      .BULLET_POINTS.BULLET_3
                  }
                </li>
              </ul>
              <div
          ...
          <a href="#" style={{ color: "#60779A", textDecoration: "none" }}>
            Back To Top
          </a>
          <hr
            style={{
              borderTop: "1px solid #60779A",
              marginLeft: "45%",
              width: "10%",
            }}
          />
