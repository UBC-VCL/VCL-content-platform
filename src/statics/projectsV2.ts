...
const PROJECT_TEXT: PROJECT[] = [
    {
        ...
        description: {
            ...
            emphasis: "The Perception of Correlation has been thought to be done through a slow top-down process, however, there is evidence that suggests it is actually done through a fast bottom-up process--a visual process. The Correlation Team focuses on researching and gathering more evidence to support this “new science of visual perception",
        },
        qa: [
            {
    ...
    },
    {
        ...
        description: {
            ...
            emphasis: "Inattentional Blindness is the phenomenon that occurs when something is plainly in the field of view but is not consciously perceived.",
        },
        qa: [
            {
    ...
    },
    {
        ...
        description: {
            ...
            emphasis: "Who is really behind the movements of the planchette? Can this phenomenon be explained by psychology?",
        },
        qa: [
            {
                q: "What is implicit cognition?",
