...
const PROJECT_TEXT: PROJECT[] = [
    ...
    description: {
      first: (
        <span>
          ...
          methods from&nbsp;
          <a
            href="https://en.wikipedia.org/wiki/Psychophysics"
            style={{ color: "white" }}
            target="_blank"
          >
            psychophysics
        ...
        description: {
          first: (
            <span>
              ...
              perception follows{""}
              <a href="https://en.wikipedia.org/wiki/Weber%E2%80%93Fechner_law">
                Weber’s law
              </a>{" "}
  ...
  },
  {
    ...
    description: {
      first: "Hi there! We are the coding team of the VCL!",
      second:
